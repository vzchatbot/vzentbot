			...
			if(session.attributes.currentintent) {
				if(session.attributes.currentintent == 'slowspeed'){
					...
					// }
						...
						repromptText = "Are you there! Do you want me to place an order for F'\yos Optical Network Terminal battery backup unit?";
						speechOutput = 'Okay! Let\'s replace your F\'yos Optical Network Terminal battery backup unit, <break time="1s"/> the cost of the unit was $39.99. <break time="1s"/> Shall i go head and place an order for F\'yos <say-as interpret-as=\'spell-out\'>ONT</say-as> battery backup unit?';
			...
			if(session.attributes.currentintent) {
				if(session.attributes.currentintent == 'slowspeed'){
					...
					// }
						...
						speechOutput = 'Okay let\'s troubleshoot, <break time="1s"/> plesae make sure the F\'yos Optical Network Terminal battery backup unit is plugged directly into a working electrical outlet. ' + 
						...
						repromptText = "Are you there! Do you want me to place an order for F'\yos Optical Network Terminal battery backup unit?";
						speechOutput = "Okay! Let\'s replace your F'\yos Optical Network Terminal battery backup unit, <break time='1s'/> the cost of the unit is $39.99. <break time='1s'/> Shall i go head and place an order?";
	...
	try {
			...
			if(subflow != null)
			{
				...
				if(!session.new) {
						...
						speechOutput = "Okay! I see you have one alert which says your F'\Yos Optical Network Terminal battery backup Unit condition is bad and beeping too. <break time='1s'/> It's time to replace your F'\yos Optical Network Terminal Battery Backup Unit now. <break time='1s'/> Do you want to replace or troubleshoot first?";
						repromptText = "Are you still there? Can you tell me whether you want to replace your f'\yos Optical Network Terminal battery back up unit?";
					...
					speechOutput = "Welcome to F'\Yos, <break time='1s'/> I see you have one alert which says your F'\Yos Optical Network Terminal battery backup Unit condition is bad and beeping too. <break time='1s'/> It's time to replace your F'\yos Optical Network Terminal Battery Backup Unit now. <break time='1s'/> Do you want to replace or troubleshoot first?";
					repromptText = "Are you still there? Can you tell me whether you want to replace your F'\yos Optical Network Terminal battery back up unit or first troubleshoot?";
